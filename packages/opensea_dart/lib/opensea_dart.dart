...
class OpenSea {
  ...
  Future<CollectionObject> getCollection(String collection, {required String slug}) async {
  ...
  /// cursor: a custom cursor used to advance to the next page
  ...
  Future<AssetsObject> getAssets(
    ...
    if (tokenIds != null) {
      queryParameters["token_ids"] = tokenIds as String;
    }
    if (assetContractAddress != null) {
      queryParameters["asset_contract_address"] = assetContractAddress;
    }
    if (assetContractAddresses != null) {
      queryParameters["asset_contract_addresses"] = assetContractAddresses as String;
    }
